...
import AutoComplete, { AutoCompleteProps, OptionDataType } from './autoComplete'
...
describe('test AutoComplete component', () => {
  ...
  it('renderOption should generate the right template', async () => {
    cleanup();
    const optionWrapper: RenderResult = render(<AutoComplete {...renderOptionProps}/>);
    const optionInputNode: HTMLInputElement = optionWrapper.getByPlaceholderText('auto-complete') as HTMLInputElement;
